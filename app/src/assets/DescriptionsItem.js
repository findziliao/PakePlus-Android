import{a as d,c as e,ab as L,j as C,b as k,bw as V,bx as F,d as M,u as G,n as D,l as O,a2 as I,q as H,cv as q,h as n,b_ as K,e5 as N}from"./index.js";import{u as W}from"./use-compitable.js";import{g as J}from"./get-slot.js";function B(t,p="default",l=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const b=i[p];if(typeof b=="function")return b()}return l}const E="DESCRIPTION_ITEM_FLAG";function Q(t){return typeof t=="object"&&t&&!Array.isArray(t)?t.type&&t.type[E]:!1}const U=d([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
